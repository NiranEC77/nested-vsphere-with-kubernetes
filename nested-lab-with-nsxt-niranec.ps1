...
# Network Segment
$NetworkSegmentName = "niranec-Uplink"
...
$NSXTMgrDisplayName = "niranec-nsx-mgr"
$NSXTMgrHostname = "niranec-nsx-mgr.corp.local"
$NSXTMgrIPAddress = "192.168.110.33"
...
$NSXTEdgeHostnameToIPs = @{
    "niranec-nsx-edge" = "192.168.110.45"
}
